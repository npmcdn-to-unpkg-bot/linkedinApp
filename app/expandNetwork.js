...
var littleExpand = function(){
	...
	.then(function(){
		x(cat[count].consultedpeople[i].adress, '.profile-aux', '.button-primary')
		(function(err, title) {
			console.log("the title is "+ title);
  if (Math.random()*100 >=70){console.log("sending the invitation")}else{console.log("not sending the invitation")} // Google
})
	})
